...
<div class="pad_10">
    <div class="common-form">
        <form name="myform" action="<?php echo Url::toRoute('/storage/add'); ?>" method="post" id="myform">
            <table width="100%" class="table_form contentWrap">
                <tr>
                    <th width="100">冷库名称：</th>
                    <td><input type="text" name="storage[name]" value="" class="form-control-table width-160" id="User-name" style="display: inline" ></td>
                </tr>
                <tr>
                    <th width="100">备注信息：</th>
                    <td><input type="text" name="storage[comment]" value="" class="width-160 form-control" id="User-alias" style="display: inline"></td>
                </tr>

                <tr>
                    <th width="100">排序：</th>
                    <td><input type="text" name="storage[sort]" maxlength="11" value="0" class="width-160 form-control" id="User-sort" style="display: inline"></td>
                </tr>
                <tr>
                    <th width="100">状态：</th>
                    <td>
                        <input type="radio" name="storage[status]" value="0" checked>正常
                        <input type="radio" name="storage[status]" value="1">禁止
                    </td>
                </tr>
            </table>
