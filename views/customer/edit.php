...
<div class="pad_10">
    <div class="common-form">
        <form name="myform" action="<?php echo Url::toRoute(['/customer/edit','id'=>$model->id]); ?>" method="post" id="myform">
            <table width="100%" class="table_form contentWrap">
                <tr>
                    <th width="100">客户姓名：</th>
                    <td><input type="text" name="customer[name]" value="<?=$model->name;?>" class="form-control-table width-160" id="User-name" style="display: inline" ></td>
                </tr>
                <tr>
                    <th width="100">其他姓名：</th>
                    <td><input type="text" name="customer[alias]" value="<?=$model->alias;?>" class="width-160 form-control" id="User-alias" style="display: inline"></td>
                </tr>

                <tr>
                    <th width="100">手机号：</th>
                    <td><input type="text" name="customer[mobile]" maxlength="11" value="<?=$model->mobile;?>" class="width-160 form-control" id="User-mobile" style="display: inline"></td>
                </tr>
                <tr>
                    <th width="100">排序：</th>
                    <td><input type="text" name="customer[sort]" maxlength="11" value="<?=$model->sort;?>" class="width-160 form-control" id="User-sort" style="display: inline"></td>
                </tr>
            </table>
